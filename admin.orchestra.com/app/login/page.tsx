        ...
        <div className="mx-auto w-full max-w-md flex flex-col min-h-[600px] justify-center">
          <div className="mb-10 flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-gray-900">
              Orchestrator <span className="text-indigo-600">ERP</span>
            </h1>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Enter your credentials to access your admin workspace.
            </p>
          </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Need help? <a href="#" className="font-semibold text-indigo-600 hover:underline">Contact System Support</a>
          </p>
          ...
          <div className="max-w-xl space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-1000">
            <div className="space-y-4">
              <h3 className="text-4xl font-bold leading-tight">
                Manage your global operations with precision and speed.
              </h3>
              <p className="text-xl text-indigo-100/90 leading-relaxed font-light">
                Orchestrator ERP connects every aspect of your business—from supply chain to customer relations—in one secure, intelligent platform.
              </p>
            </div>
