...
| Service Configuration (Printing MRP) | 📋 Planned | Dynamic service configuration for printing operations (silk screen, DTF, sublimation) with BOM auto-selection and pricing. |
